...
layout_test = [[["Esc",1,1,-2], ["",-1,1,0], ["F1",1,1,-2], ["F2",1,1,-2], ["F3",1,1,-2], ["F4",1,1,-2], ["",-.5,1,0], ["F5",1,1,-2], ["F6",1,1,-2], ["F7",1,1,-2], ["F8",1,1,-2], ["",-.5,1,0], ["F9",1,1,-2], ["F10",1,1,-2], ["F11",1,1,-2], ["F12",1,1,-2],                         ["",-0.5,1,0], [["Print","Screen"],1,1,-3], [["Scroll", "Lock"],1,1,-3], [["Pause","Break"],1,1,-3]],
...
full_size_dual_legends = [ for (row = layout_test) [ for (col = row) col[0]]];
full_size_dual_default_layout = [ for (row = layout_test) [ for (col = row) col[1]]];
full_size_dual_vertical_size = [ for (row = layout_test) [ for (col = row) col[2]]];
full_size_dual_legend_size = [ for (row = layout_test) [ for (col = row) col[3]]];
